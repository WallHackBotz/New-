...
try {
 await m.reply('Searching...')
    ...
    axios.get(`https://api-invibot.herokuapp.com/api/download/mediafire?url=https://www.mediafire.com/file/v035jsup2d2wp1n/textprome.js/file&apikey=APIKEY`).then ((res) => {
